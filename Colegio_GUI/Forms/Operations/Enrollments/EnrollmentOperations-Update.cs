...
{
    public partial class EnrollmentOperations_Update : Form
    {
        ...
        public EnrollmentOperations_Update()
        {
            InitializeComponent();
        }

        private void EnrollmentOperations_Update_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                */
                ...
                lblEnrollmentID.Text = this.enrollmentID.ToString();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (objEnrollmentBL.UpdateEnrollment(objEnrollmentBE) == true)
            {
